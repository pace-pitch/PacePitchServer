...
Video Upload API
- API version: 1.0.0
  - Build date: 2024-05-27T14:41:17.454227+09:00[Asia/Seoul]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**sessionSessionIdRecordsNewPost**](docs/DefaultApi.md#sessionSessionIdRecordsNewPost) | **POST** /session/{sessionId}/records/new | Upload a video file
